...
![Header](https://capsule-render.vercel.app/api?type=waving&color=auto&height=300&section=header&text=Reinfors&fontSize=90&animation=fadeIn&fontAlignY=38&desc=Developer%20%7C%20Gamer&descAlignY=51&descAlign=62)

### 🚀 About Me

I’m a hobby developer who loves working with **JavaScript**, **Node.js**, and **Lua** to create cool stuff like Discord bots, FiveM scripts, and other fun projects. I’m always looking to level up my coding skills and try out new programming languages.
...
**Note:** "Top Languages" is simply a metric based on the languages used across my code, both public and private, and does not necessarily reflect my experience or level of proficiency in each language
<br/>
...
<p>
    <a href="https://github.com/Reinfors-Asterax" target="_blank">
